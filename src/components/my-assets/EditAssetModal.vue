        ...
        <div class="modal-body">
          ...
          <form @submit.prevent="handleSubmit">
            <div class="mb-3">
              ...
              <input id="codigo" v-model="formData.codigo" type="text" class="form-control" readonly />
            </div>

            <div class="mb-3">
              <label for="nome" class="form-label fw-semibold">Nome</label>
              <input id="nome" v-model="formData.nome" type="text" class="form-control" readonly />
            </div>

          ...
          <div class="modal-dialog">
            <div class="modal-header">
              <h3 class="modal-title">
                <svg class="modal-icon" :class="`icon-${type}`" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path v-if="type === 'success'" d="M5 3 L19 12 L5 21 Z" />
            ...
            <div class="modal-body">
              ...
              <p v-if="warningMessage" class="modal-warning">
            ...
            <div class="modal-footer">
              <slot name="footer">
                <button type="button" class="btn btn-secondary" :disabled="loading" @click="close">Cancelar</button>
                <button type="button" class="btn btn-confirm" :class="`btn-${type}`" :disabled="loading" @click="handleConfirm">

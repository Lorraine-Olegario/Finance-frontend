  ...
  <tr class="asset-row">
    ...
    <td class="text-center">
      <div class="action-buttons">
        <button class="action-btn edit-btn" :title="asset.alert ? 'Editar alerta' : 'Configurar alerta'" @click="$emit('edit', asset)">
        ...
        <button class="action-btn delete-btn" title="Parar de observar" @click="$emit('stop', asset)">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">

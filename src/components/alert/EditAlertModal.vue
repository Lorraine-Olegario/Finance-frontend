    ...
    <template #default>
      ...
      <form @submit.prevent="handleSubmit">
        <div class="form-group">
          ...
          <input
            id="valor_min"
            v-model.number="formData.valor_min"
            type="number"
            step="0.01"
            min="0"
          ...
          <small class="help-text">
            Você será notificado quando o valor cair abaixo deste limite
          </small>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            id="valor_max"
            v-model.number="formData.valor_max"
            type="number"
            step="0.01"
            min="0"
          ...
          />
          <small class="help-text">
            Você será notificado quando o valor ultrapassar este limite
          </small>
        </div>
        ...
        <div class="checkbox-group">
          <label class="checkbox-label">
            <input
              v-model="formData.notificar_valor_min"
              type="checkbox"
            />
        ...
        <div class="checkbox-group">
          <label class="checkbox-label">
            <input
              v-model="formData.notificar_valor_max"
              type="checkbox"
            />
  ...
  methods: {
    handleSubmit() {
      ...
      if (!this.formData.valor_min && !this.formData.valor_max) {
        this.error =
          'Por favor, configure pelo menos um valor (mínimo ou máximo).'
        return
      }

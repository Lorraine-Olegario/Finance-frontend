<template>
  <div v-if="total > 0" class="pagination-container">
    <!-- Total Label -->
    <div v-if="showTotal" class="total-section">
      <slot name="totalLabel" :total="total">
        Total:
        <strong>{{ total }}</strong>
      </slot>
    </div>
    ...
    <div class="pagination-controls">
      <button class="pagination-btn prev" :disabled="currentPage === 1" @click="$emit('page-change', currentPage - 1)" title="Página anterior">
      ...
      <button class="pagination-btn next" :disabled="currentPage === lastPage" @click="$emit('page-change', currentPage + 1)" title="Próxima página">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <!-- Page Info -->
    <div v-if="showPageInfo" class="page-info">Página {{ currentPage }} de {{ lastPage }}</div>
  </div>
</template>

  ...
  <MainLayout page-title="Categorias">
    <div class="categories-page">
      ...
      <div v-else-if="error" class="error-message">
        ...
        <p>{{ error }}</p>
        <button class="btn" @click="fetchCategories">Tentar Novamente</button>
      </div>
      ...
      <ConfirmationModal
        ...
        <div>
          <div class="form-group">
            ...
            <input v-model="formData.nome" type="text" placeholder="Ex: Ações, FIIs, Criptomoedas" class="form-input" />
          </div>
          <div class="form-group">
            <label>Cor</label>
            <div class="color-picker-group">
              <input v-model="formData.color" type="color" class="color-input" />
              <input v-model="formData.color" type="text" placeholder="#6200EE" class="form-input" maxlength="7" />
            </div>
          </div>

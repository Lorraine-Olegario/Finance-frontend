    ...
    <div class="users-page">
      ...
      <ConfirmationModal
        ...
        <div>
          <div class="form-group">
            ...
            <input v-model="formData.name" type="text" placeholder="Ex: João Silva" class="form-input" />
          </div>
          <div class="form-group">
            <label>Email *</label>
            <input v-model="formData.email" type="email" placeholder="Ex: joao.silva@example.com" class="form-input" />
          </div>
          <div class="form-group">
            <label>Senha *</label>
            <input v-model="formData.password" type="password" placeholder="Digite a senha" class="form-input" />
          </div>
          <div class="form-group">
            <label>Confirmar Senha *</label>
            <input v-model="formData.password_confirmation" type="password" placeholder="Digite a senha" class="form-input" />
          </div>
      ...
      <div class="card">
        ...
        <div class="search-bar">
          <input v-model="searchQuery" type="text" placeholder="Buscar por nome ou email..." class="search-input" />
        </div>
  ...
  export default {
    ...
    computed: {
      filteredUsers() {
        ...
        return this.users.filter((user) => user.name.toLowerCase().includes(query) || user.email.toLowerCase().includes(query));
      },
    },
    mounted() {
      this.fetchUsers();

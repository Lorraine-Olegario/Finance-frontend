  ...
  <MainLayout page-title="Configurações de Cores">
    <div class="settings-page">
        ...
        <div v-for="(color, categoria) in categoryColors" :key="categoria" class="color-setting-card card">
          <div class="color-setting-content">
            ...
            <div class="color-picker-container">
              <input v-model="categoryColors[categoria]" type="color" class="color-picker" @change="markAsChanged" />
      ...
      <div v-if="hasChanges" class="action-buttons">
        <button :disabled="saving" class="btn btn-primary" @click="saveColors">
          {{ saving ? "Salvando..." : "Salvar Cores" }}
        </button>
        <button :disabled="saving" class="btn btn-secondary" @click="resetColors">Resetar</button>
      </div>

      ...
      <div class="card search-card">
        <div class="form-group">
          ...
          <div class="search-input-group">
            <input v-model="searchCode" type="text" placeholder="Digite o código do ativo (ex: PETR4)" @keyup.enter="searchHistory" />
            <button :disabled="!searchCode || loading" @click="searchHistory">Buscar</button>
          </div>
        </div>
      </div>

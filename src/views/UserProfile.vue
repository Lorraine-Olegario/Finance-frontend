        ...
        <div class="profile-card">
          ...
          <form class="profile-form" @submit.prevent="handleUpdateProfile">
            <div class="form-group">
              ...
              <input id="name" v-model="profileForm.name" type="text" placeholder="Digite seu nome" required />
            </div>

            <div class="form-group">
              <label for="email">E-mail</label>
              <input id="email" v-model="profileForm.email" type="email" placeholder="Digite seu e-mail" required />
            </div>
            ...
            <div class="form-actions">
              <button type="submit" class="btn-primary" :disabled="savingProfile">
                <svg v-if="!savingProfile" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <form class="profile-form" @submit.prevent="handleChangePassword">
            ...
            <div class="form-actions">
              <button type="submit" class="btn-primary" :disabled="savingPassword">
                <svg v-if="!savingPassword" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                  <path d="M7 11V7a5 5 0 0 1 10 0v4" />
                </svg>
